...
- `${CLAUDE_PLUGIN_ROOT}/skills/dotnet-service-generator/references/standard-service.md` — canonical folder structure
- `${CLAUDE_PLUGIN_ROOT}/skills/dotnet-service-generator/references/dependencies.md` — dependency and long-lived subscriber patterns
- `${CLAUDE_PLUGIN_ROOT}/skills/dotnet-service-generator/references/modular-polylith.md` — module/component hierarchy (if module name provided)
