...
Load and follow `${CLAUDE_PLUGIN_ROOT}/skills/cross-vendor-examine/SKILL.md` for the complete review protocol, peer discovery rules, CLI execution guardrails, and synthesis format.
