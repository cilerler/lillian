...
| `.agent/skills/INDEX.md` | Skill routing and library references |
| `.github/agents/*.agent.md` | Role definitions and behaviors |
| `.agent/rules/*.md` | Technology-specific conventions (Blazor, C#, SQL, Infrastructure, Testing) |

When working on a specific technology, also load the corresponding instruction file from `.agent/rules/`.
