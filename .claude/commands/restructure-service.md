...
- `.claude/skills/dotnet-service-generator/references/standard-service.md` — canonical folder structure
- `.claude/skills/dotnet-service-generator/references/modular-monolith.md` — module/component hierarchy (if module name provided)
