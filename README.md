...
- **solution-structure**: Source of truth for the opinionated .NET solution folder structure, including in-repo documentation paths and filenames, test-project paths and names, root scaffolding, sibling Host and contract projects, modular or standalone services under /src, /tools/Kubernetes, and /tests.
